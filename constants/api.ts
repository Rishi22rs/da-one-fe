...
// export const baseURL = `http://10.101.205.161:3000/api`;
// export const baseURLSocket = `http://10.101.205.161:3000`;
export const baseURLSocket = `https://da-one-be.onrender.com`;
